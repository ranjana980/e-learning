                ...
                <div className='home'>
                    ...
                    <div className='row mt-5'>
                        <div className='col-lg-5'>
                            <h1 style={{ textAlign: 'start', color: 'white', fontFamily: 'cursive', fontWeight: '600' }}><b style={{ color: '#a212ff', filter: 'drop-shadow(2px 2px 2px 2px #a212ff)' }}>1</b> to <b style={{ color: '#a212ff', filter: 'drop-shadow(2px 2px 2px 2px rgb(48 117 224))' }}>5</b> Standard</h1>
            ...
            <div className='learning-div mt-2'>
                ...
                <div className='row slide'>
                    ...
                    <div className='col-lg-6 col-sm-8' style={{ backgroundColor: '#a212ff', borderRadius: '10px' }}>
                        ...
                        <Carousel responsive={responsive} swipeable={true} arrows={true} autoPlay={true} slidesToSlide={1}>
                ...
                <div className='sm-div'>
                    ...
                    <div className='image-div'>
                        <h2 className='d-flex justify-content-center p-5' style={{ fontFamily: 'cursive', }}><h2 className='mr-3' style={{ color: '#a212ff', filter: 'drop-shadow(2px 2px 2px 2px #a212ff)', fontFamily: 'cursive', }}> Parents </h2> talk</h2>

                        <div className='row'>
                            <div className='col-lg-1 col-sm-1 mr-1'>
                                <img src="https://www.cherrilearn.com/static/media/SBG.d3f75d86.png" style={{ height: '800px', width: '200px' }} />
                            </div>
                            <div className='col-lg-10 col-sm-6 ml-5'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-5 col-sm-10 justify-content-start'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-12'>
                            <img className='ml-3 mt-3' style={{ borderRadius: '10px' }} src="https://pbs.twimg.com/media/FfgpoRrUAAI9gJf.jpg" />
                        </div>
                    ...
                    <div className='row mt-5'>
                        ...
                        <div className='col-5 mt-5'>
                            ...
                            <ul className='mt-4' style={{ color: 'white', display: 'flex', justifyContent: 'center' }}>
                            ...
                            <ul className='mt-4' style={{ color: 'white', display: 'flex', justifyContent: 'center', listStyle: 'none' }}>
